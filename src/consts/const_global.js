...
if ( consts.DEBUG === true ) {
    ...
    consts.SETTINGS.NODE.VERSION = "1.209.1";
    consts.SETTINGS.NODE.VERSION_COMPATIBILITY = "1.209.1";
    consts.SETTINGS.NODE.VERSION_COMPATIBILITY_POOL_MINERS = "1.209.1";
