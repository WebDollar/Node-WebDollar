...
consts.BLOCKCHAIN = {
    ...
    HARD_FORKS : {
        ...
        // POS_ACTIVATION_90: 1000000

        WALLET_RECOVERY: 20,

        TRANSACTIONS_BUG_2_BYTES: 10,
        TRANSACTIONS_OPTIMIZATION: 30,

        DIFFICULTY_TIME_BIGGER: 20,
        DIFFICULTY_REMOVED_CONDITION: 40,

        TRANSACTIONS_INCLUDING_ONLY_HEADER: 50, // SAME AS POS
        POS_ACTIVATION: 60,
        POS_ACTIVATION_90: 100
...
consts.SETTINGS = {
    ...
    NODE: {
        ...
        VERSION_COMPATIBILITY: "1.300.0",
        VERSION_COMPATIBILITY_POOL_MINERS: "1.300.3",
