...
if ( consts.DEBUG === true ) {
    ...
    consts.SETTINGS.NODE.VERSION = "1.207.6";
    consts.SETTINGS.NODE.VERSION_COMPATIBILITY = "1.207.3";
    consts.SETTINGS.NODE.VERSION_COMPATIBILITY_POOL_MINERS = "1.207.3";
