...
class InterfaceBlockchainBlockCreator{
    ...
    _createBlockNew(height, blockValidation, minerAddress, transactions, args){
        ...
        return new this.blockClass( this.blockchain, blockValidation, 1, undefined, this.blockchain.getHashPrev(),   this.blockchain.getChainHash(), undefined, 0, data, height, this.db);
