...
var root = "http://127.0.0.1:2224/public/"; // for localhost only
...
function calcAsmJs() {
    ...
    let promise = new Promise( async (resolve) => {
        ...
        loadScript(root + 'WebDollar-dist/argon2/argon2-asm.min.js', () => {
...
function calcBinaryen(method) {
    ...
    let promise =  new Promise (async (resolve)=>{
        ...
        xhr.onload = () => {
            ...
            loadScript(root + 'WebDollar-dist/argon2/argon2.min.js', () => {
                log('Script loaded in ' + Math.round(now() - ts) + 'ms');
                log('Calculating hash....');
