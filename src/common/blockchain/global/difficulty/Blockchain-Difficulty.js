...
class BlockchainDifficulty{
    ...
    static async getDifficultyMeanPOW( getDifficultyCallback, getTimeStampCallback, blockTimestamp, blockNumber){

        let prevBlockDifficulty = await getDifficultyCallback( blockNumber, true );
    ...
    static async getDifficultyMeanPOS( getDifficultyCallback, getTimeStampCallback, blockTimestamp, blockNumber ){
