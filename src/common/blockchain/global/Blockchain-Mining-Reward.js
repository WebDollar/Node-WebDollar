...
class BlockchainMiningReward {
  /**
     ...
     */
  getSumReward (height) {
    if (typeof height !== 'number') { throw { message: 'height is not defined' } }
  ...
  getReward (height) {
    ...
    if (height <= 40) {
      ...
      if (reward < smallestReward) { reward = smallestReward }
