...
class PoolDataBlockInformation {
    ...
    _calculateTimeRemaining(){
        ...
        // reducing the timeRemaining with 10x
        this.timeRemaining = Math.max(0, Math.floor(  new BigNumber (  Math.floor( Blockchain.blockchain.blocks.networkHashRate)  ).dividedBy( this.poolManagement.poolStatistics.poolHashes ).dividedBy(10).multipliedBy( consts.BLOCKCHAIN.DIFFICULTY.TIME_PER_BLOCK ).toNumber()  ) )
