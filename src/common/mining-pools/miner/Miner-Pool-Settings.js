...
class MinerPoolSettings {
    ...
    async _addPoolsList(){
        ...
        await this.addPoolList("/pool/1/WMP/0.02/f07fc1b5aa75fd835773d965b427339c072457edd4f7bc26f3918336f6284ed2/https:$$server.webdollarminingpool.com:443", undefined, true);
