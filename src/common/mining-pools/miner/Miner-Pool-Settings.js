...
class MinerPoolSettings {
    ...
    async _addPoolsList(){
        ...
        await this.addPoolList("/pool/1/WMP/0.02/bdda9527a040d9063e22e1dccc4d860b84227ff73232f5c418054112114a6ea4/https:$$pool.webdollarminingpool.com:443", undefined, true);
