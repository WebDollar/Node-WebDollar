...
class Log {
  ...
  info (msg, config = LOG_TYPE.DEFAULT, msg2, msg3) {
    if (this.loggers[ config ] !== undefined) { this.loggers[ config ].info.apply(this.loggers[ config ], arguments) }
  }
  ...
  log (msg, config = LOG_TYPE.DEFAULT, msg2, msg3) {
    if (this.loggers[ config ] !== undefined) { this.loggers[ config ].log.apply(this.loggers[ config ], arguments) }
  }
  ...
  debug (msg, config = LOG_TYPE.DEFAULT, msg2, msg3) {
    if (this.loggers[ config ] !== undefined) { this.loggers[ config ].debug.apply(this.loggers[ config ], arguments) }
  }
  ...
  error (msg, config = LOG_TYPE.DEFAULT, msg2, msg3) {
    if (this.loggers[ arguments[1] ] !== undefined) { this.loggers[ arguments[1] ].error.apply(this.loggers[ arguments[1] ], arguments) }
  }
  ...
  warn (msg, config = LOG_TYPE.DEFAULT, msg2, msg3) {
    if (this.loggers[ arguments[1] ] !== undefined) { this.loggers[ arguments[1] ].warn.apply(this.loggers[ arguments[1] ], arguments) }
  }
}
