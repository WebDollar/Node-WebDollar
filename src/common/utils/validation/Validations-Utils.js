...
class ValidationsUtils {
  ...
  async clearIndexedDB () {
    ...
    if (!confirm('Are you WANT TO DELETE YOUR WALLET?')) { return false }
  ...
  testPounchDB (dbName, timeoutTime = TIME_OUT) {
    return new Promise(async (resolve) => {
      ...
      try {
        ...
        if (number !== number2 || number === null || number2 === null) { throw (number === undefined ? 'undefined' : number.toString()) + ' !== ' + (number2 === undefined ? 'undefined' : number2.toString()) }
  ...
  async testPounchDB2 (dbName, timeoutTime = TIME_OUT) {
    ...
    try {
      ...
      if (number !== number2 || number === null || number2 === null) { throw (number === null ? 'null' : number.toString()) + ' !== ' + (number2 === null ? 'null' : number2.toString()) }
