...
describe('test PPoW-Blockchain interlink data structure', () => {
    ...
    it('test serialize interlink data structure', async () => {
        ...
        let block = new MiniBlockcainBlock( blockchain, blockchain.createBlockValidation(), 0x01, new Buffer(consts.BLOCKCHAIN.BLOCKS_POW_LENGTH), new Buffer(consts.BLOCKCHAIN.BLOCKS_POW_LENGTH), undefined, undefined, undefined, 0, blockchain.db );
    ...
    it('test creating Interlink data structure', async () => {
        ...
        for (let i = 0; i < serialized.length; ++i) {
            ...
            let block = new MiniBlockcainBlock( blockchain, blockchain.createBlockValidation(), 0x01, new Buffer(consts.BLOCKCHAIN.BLOCKS_POW_LENGTH), new Buffer(consts.BLOCKCHAIN.BLOCKS_POW_LENGTH), undefined, undefined, undefined, i, blockchain.db );
