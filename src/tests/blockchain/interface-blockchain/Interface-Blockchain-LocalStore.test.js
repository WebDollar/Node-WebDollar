...
describe('test Interface-Blockchain save/load/remove to/from local storage', () => {
    ...
    it('save/load/remove blockchain, sample test', async () => {
        ...
        let b0 = new InterfaceBlockchainBlock( Blockchain.blockchain, Blockchain.blockchain.blockValidation, 0x01, new Buffer(consts.BLOCKCHAIN.BLOCKS_POW_LENGTH), new Buffer(consts.BLOCKCHAIN.BLOCKS_POW_LENGTH), undefined, undefined, undefined, 0, blockchain.db );
        let b1 = new InterfaceBlockchainBlock( Blockchain.blockchain, Blockchain.blockchain.blockValidation, 0x01, new Buffer(consts.BLOCKCHAIN.BLOCKS_POW_LENGTH), new Buffer(consts.BLOCKCHAIN.BLOCKS_POW_LENGTH), undefined, undefined, undefined, 1, blockchain.db );
        let b2 = new InterfaceBlockchainBlock( Blockchain.blockchain, Blockchain.blockchain.blockValidation, 0x01, new Buffer(consts.BLOCKCHAIN.BLOCKS_POW_LENGTH), new Buffer(consts.BLOCKCHAIN.BLOCKS_POW_LENGTH), undefined, undefined, undefined, 2, blockchain.db );
        let b3 = new InterfaceBlockchainBlock( Blockchain.blockchain, Blockchain.blockchain.blockValidation, 0x01, new Buffer(consts.BLOCKCHAIN.BLOCKS_POW_LENGTH), new Buffer(consts.BLOCKCHAIN.BLOCKS_POW_LENGTH), undefined, undefined, undefined, 3, blockchain.db );
