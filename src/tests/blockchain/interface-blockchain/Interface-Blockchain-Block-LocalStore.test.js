...
describe('test Interface-Block save/load/remove to/from local storage', () => {
    ...
    it('save/load/remove block to local storage, sample test', async () => {
        ...
        block = new InterfaceBlockchainBlock( Blockchain.blockchain,  Blockchain.blockchain.createBlockValidation(), version, hash, hashPrev, hashChainPrev, timeStamp, nonce, data, height, db );
