...
describe('test transactions', () => {
    ...
    it('verify transactions, sample test', async () => {
        ...
        //create dummy blocks
        let b0 = new InterfaceBlockchainBlock( blockchain, blockchain.blockValidation,  0, Buffer.alloc(consts.BLOCKCHAIN.BLOCKS_POW_LENGTH), Buffer.alloc(consts.BLOCKCHAIN.BLOCKS_POW_LENGTH), undefined, undefined, undefined, 0, blockchain.db );
