...
describe('Interface Accountant Radix Tree', () => {
    ...
    it('creating & deleting Accountant Radix tree - generalized permutations of different strings with small lengths', () => {

        accountantData = TestsHelper.makeSetIdAndNumber(6, true, 10000);
        let testStrings = [];
        for (let i = 0; i < accountantData.length; ++i)
