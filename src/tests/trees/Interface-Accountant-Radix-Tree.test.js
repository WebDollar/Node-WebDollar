...
import InterfaceAccountantRadixTree from 'common/trees/radix-tree/account-tree/Interface-Accountant-Radix-Tree-Node'
...
describe('Interface Accountant Radix Tree', () => {
    ...
    it('creating Accountant Radix tree', ()=>{
        ...
        accountantData.forEach( (data)=>{
            accountantTree.add( new WebDollarCryptoData(data.text, "ascii"),  {sum: data.value } );
        });
