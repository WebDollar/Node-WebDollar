...
if [ -z $POOL_NAME ]; then echo 'You need to input a pool name using POOL_NAME ENV variable'; fi
if [ -z $POOL_WEBSITE ]; then echo 'You need to input a pool website using POOL_WEBSITE ENV variable'; fi
